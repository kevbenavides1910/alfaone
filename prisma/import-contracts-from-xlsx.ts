...
import { ensureDefaultBillingRequirements } from "../src/modules/presupuestos/business/contractBillingRequirementsDefaults";
    ...
    try {
      await prisma.$transaction(async (tx) => {
        ...
        await ensureDefaultBillingRequirements(
          ...
          { createdById: admin.id, syncOpenFacturas: false }
        );
