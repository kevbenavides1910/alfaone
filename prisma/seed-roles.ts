...
const SYSTEM_ROLES: {
  ...
  },
  {
    ...
    permissions: {
      ...
      "pagos.calendario": PermissionLevel.EDIT,
      ...
      "fingerSystem.dashboard": PermissionLevel.VIEW,
      "fingerSystem.empresas": PermissionLevel.EDIT,
      "fingerSystem.empleados": PermissionLevel.EDIT,
      "fingerSystem.biometria": PermissionLevel.EDIT,
      "fingerSystem.dispositivos": PermissionLevel.VIEW,
      "fingerSystem.marcasEnVivo": PermissionLevel.VIEW,
      "fingerSystem.asistencia": PermissionLevel.EDIT,
      "fingerSystem.turnos": PermissionLevel.EDIT,
      "fingerSystem.reportes": PermissionLevel.VIEW,
      "fingerSystem.backups": PermissionLevel.VIEW,
      "fingerSystem.mantenimiento": PermissionLevel.VIEW,
      "fingerSystem.auditoria": PermissionLevel.VIEW,
      "fingerSystem.configuracion": PermissionLevel.VIEW,
    },
  },
  {
    code: "COMPRAS",
  ...
  },
  {
    ...
    permissions: {
      ...
      "facturacion.cobro": PermissionLevel.EDIT,
      "facturacion.cxc": PermissionLevel.EDIT,
      "pagos.calendario": PermissionLevel.VIEW,
  ...
  },
  {
    ...
    permissions: {
      ...
      "inventario.assets": PermissionLevel.VIEW,
      "fingerSystem.dashboard": PermissionLevel.VIEW,
      "fingerSystem.empresas": PermissionLevel.VIEW,
      "fingerSystem.empleados": PermissionLevel.VIEW,
      "fingerSystem.biometria": PermissionLevel.VIEW,
      "fingerSystem.dispositivos": PermissionLevel.VIEW,
      "fingerSystem.marcasEnVivo": PermissionLevel.VIEW,
      "fingerSystem.asistencia": PermissionLevel.VIEW,
      "fingerSystem.turnos": PermissionLevel.VIEW,
      "fingerSystem.reportes": PermissionLevel.VIEW,
      "fingerSystem.mantenimiento": PermissionLevel.VIEW,
      "fingerSystem.auditoria": PermissionLevel.VIEW,
    },
