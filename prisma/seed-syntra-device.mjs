/**
 * Crea o actualiza el dispositivo de prueba SYNTRA y una ruta demo.
...
async function main() {
  ...
  const route = await prisma.patrolRoute.upsert({
    ...
    create: {
      code: DEMO.routeCode,
      name: DEMO.routeName,
      description: "Ruta de prueba para app SYNTRA",
      isActive: true,
    },
    update: {
      name: DEMO.routeName,
