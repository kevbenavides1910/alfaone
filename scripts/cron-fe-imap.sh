#!/usr/bin/env bash
# Sincroniza buzones IMAP de facturas de proveedores (todas las empresas con IMAP activo).
# Programar cada 5 minutos:
#   */5 * * * * /mnt/data/projects/alfa-one/code/presupuestos-alfa/scripts/cron-fe-imap.sh >> /var/log/alfa-one/fe-imap.log 2>&1
