#!/usr/bin/env bash
# Opcional con BuildKit mount. Uso: ALFAONE_USE_DISK_CACHE=1 ... pull|push
set -euo pipefail
...
cmd="${1:-pull}"; mkdir -p "$PERSIST/next-cache" "$CTX"
case "$cmd" in
  pull)
