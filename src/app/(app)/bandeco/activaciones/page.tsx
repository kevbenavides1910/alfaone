...
export default function BandecoActivacionesPage() {
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      const r = await fetch("/api/bandeco/activaciones", {
        method: "POST",
    ...
    <div className="p-4 md:p-6 max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">
          Equivalente a la hoja ACTIVACIONES — genera informe y registra en bitácora.
        </p>
      </div>
