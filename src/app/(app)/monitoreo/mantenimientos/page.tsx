...
import { AlarmCodesTab } from "@/components/monitoreo/mantenimientos/AlarmCodesTab";
import { PantallasTab } from "@/components/monitoreo/mantenimientos/PantallasTab";
import { PuestosTab } from "@/components/monitoreo/mantenimientos/PuestosTab";
import { CamarasTab } from "@/components/monitoreo/mantenimientos/CamarasTab";
import { AperturasTab } from "@/components/monitoreo/mantenimientos/AperturasTab";
import { PilasTab } from "@/components/monitoreo/mantenimientos/PilasTab";
...
function MantenimientosContent() {
  ...
  async function handleImport(file: File) {
    ...
    try {
      ...
      fd.append("file", file);
      const r = await fetch("/api/monitoreo/import", { method: "POST", body: fd });
  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl font-semibold">Mantenimientos Monitoreo</h1>
