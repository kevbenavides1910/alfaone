...
const QUICK_LINKS = [
  ...
  { href: "/recorridos/configuracion", label: "Configuración app", icon: Settings2, desc: "Parámetros Alfa One" },
  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl mx-auto w-full">
      <RecorridosPageHeader
        ...
        description="Supervise dispositivos Alfa One, rutas NFC, asignaciones diarias y cumplimiento de marcas."
      />
