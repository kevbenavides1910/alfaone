...
import { CheckCircle2, FileSpreadsheet, XCircle, FileText, MapPin, FileBarChart } from "lucide-react";
  ...
  return (
    <div className="p-6 space-y-6 max-w-[1400px] mx-auto w-full">
      <RecorridosPageHeader
        ...
        description="Cumplimiento de rondas NFC registradas desde la app Alfa One."
      />
