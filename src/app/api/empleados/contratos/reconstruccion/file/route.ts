...
import { readReconstruccionPdf } from "@/modules/empleados/services/reconstruccion-e5-review";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const file = await readReconstruccionPdf(id);
    ...
    return serverError("Error al leer PDF reconstruido", e);
  }
}
