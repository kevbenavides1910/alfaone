...
export async function PATCH(req: NextRequest) {
  ...
  try {
    ...
    const updated = await updateFingerSettings({
      ...
      attSmbUser: body.attSmbUser !== undefined ? String(body.attSmbUser) : undefined,
      attSmbPassword: body.attSmbPassword !== undefined ? String(body.attSmbPassword) : undefined,
      clearAttSmbPassword: body.clearAttSmbPassword === true,
