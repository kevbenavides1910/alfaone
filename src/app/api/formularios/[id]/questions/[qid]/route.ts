...
import { deleteQuestion, updateQuestion } from "@/modules/formularios/services/forms";
...
export async function PATCH(req: NextRequest, ctx: Ctx) {
  ...
  try {
    ...
    const row = await updateQuestion(qid, parsed);
    return ok({
      ...row,
    ...
    return serverError("Error al actualizar pregunta", e);
  }
}
...
export async function DELETE(_req: NextRequest, ctx: Ctx) {
  ...
  try {
    ...
    return serverError("Error al eliminar pregunta", e);
  }
}
