  ...
  return (
    <nav
      ...
      className={cn(
        ...
        variant === "alfa" &&
          "border-b border-[#2a2a2a] bg-[#121212]/95 backdrop-blur-md text-white shadow-md shadow-black/10",
        variant === "light" &&
    ...
    >
      {/* Línea de acento marca */}
      {variant === "alfa" && (
        <div className="h-0.5 w-full bg-[var(--app-primary)]" aria-hidden />
      )}
      <div className="flex flex-wrap items-center gap-1 px-3 py-2 md:px-5 overflow-x-auto">
        {tabs.map((tab) => {
          const Icon = tab.icon;
