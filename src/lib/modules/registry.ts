...
export const APP_MODULES: Record<AppModuleId, AppModuleMeta> = {
  ...
  "alfa-one": {
    id: "alfa-one",
    label: "Contratos",
    description: "Licitaciones, clientes, contratos e importaciones.",
    uiRoutePrefixes: [
      "/contracts",
      "/expenses",
    ],
  ...
  bandeco: {
    ...
    description: "Sistema de alarmas: consulta, activaciones, aperturas, eventos y catálogos.",
  ...
  recorridos: {
    ...
    description: "App Alfa One: dispositivos, rutas NFC, puntos, horarios y asignaciones.",
