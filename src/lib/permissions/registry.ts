...
export const PERMISSION_REGISTRY = {
  ...
  fingerSystem: {
    label: "Finger System",
    moduleId: "fingerSystem" as const,
    screens: {
      dashboard: {
        label: "Dashboard",
        uiRoutes: ["/finger-system"],
        apiPrefixes: ["/api/finger-system/dashboard", "/api/finger-system/diagnostic"],
        actions: { view: "Ver dashboard de asistencia" },
      },
      empresas: {
        label: "Empresas",
      ...
      biometria: {
        label: "Biometría",
        uiRoutes: ["/finger-system/biometria"],
        apiPrefixes: ["/api/finger-system"],
        actions: { view: "Consultar huellas", edit: "Registrar huellas" },
      },
      dispositivos: {
        label: "Dispositivos",
      ...
      asistencia: {
        label: "Asistencia",
        uiRoutes: ["/finger-system/asistencia"],
        apiPrefixes: ["/api/finger-system"],
        actions: { view: "Consultar asistencia", edit: "Calcular incidencias" },
      },
      turnos: {
        label: "Turnos",
        uiRoutes: ["/finger-system/turnos"],
        apiPrefixes: ["/api/finger-system"],
        actions: { view: "Consultar turnos", edit: "Administrar turnos" },
      },
      reportes: {
        label: "Reportes",
        uiRoutes: ["/finger-system/reportes"],
        apiPrefixes: ["/api/finger-system"],
        actions: { view: "Generar reportes", edit: "Exportar reportes" },
      },
      backups: {
        label: "Backups",
        uiRoutes: ["/finger-system/backups"],
        apiPrefixes: ["/api/finger-system"],
        actions: { view: "Consultar backups", admin: "Crear y restaurar backups" },
      },
      mantenimiento: {
        label: "Mantenimiento",
        uiRoutes: ["/finger-system/mantenimiento"],
        apiPrefixes: ["/api/finger-system/diagnostic"],
        actions: { view: "Diagnóstico del sistema", edit: "Herramientas de mantenimiento" },
      },
      auditoria: {
        label: "Auditoría",
        uiRoutes: ["/finger-system/auditoria"],
        apiPrefixes: ["/api/finger-system"],
        actions: { view: "Consultar auditoría" },
      },
      configuracion: {
        label: "Configuración",
...
export const HOME_MODULE_PERMISSION_GROUPS: {
  ...
  { tileId: "finger_system", label: "Finger System", moduleKeys: ["fingerSystem"] },
