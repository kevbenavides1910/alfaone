  ...
  bandeco: {
    ...
    screens: {
      ...
      operacion: {
        ...
        apiPrefixes: [
          "/api/bandeco/activaciones",
          "/api/bandeco/aperturas-cierres",
          "/api/bandeco/eventos",
        ],
        actions: { view: "Ver operación", edit: "Registrar activaciones, aperturas y eventos" },
      },
      registros: {
        label: "Registros e informes",
        uiRoutes: ["/bandeco/registro", "/bandeco/informe-semanal"],
        apiPrefixes: ["/api/bandeco/informe-semanal"],
        actions: { view: "Ver historial e informes" },
      },
      mantenimientos: {
        label: "Mantenimientos",
        uiRoutes: ["/bandeco/mantenimientos"],
        apiPrefixes: ["/api/bandeco/alarm-codes", "/api/bandeco/import"],
        actions: {
          view: "Ver catálogos",
          edit: "Editar bases de datos",
          admin: "Importar Excel y eliminar registros",
        },
      },
    },
  },
...
export const HOME_MODULE_PERMISSION_GROUPS: {
  ...
  { tileId: "contratos", label: "Contratos", moduleKeys: ["alfa-one"] },
