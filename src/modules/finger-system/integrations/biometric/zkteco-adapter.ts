import { createZkProtocolClient, type ZkAttendanceRecord, type ZkUserRecord } from "./zk-protocol";

import type { BiometricDeviceAdapter, BiometricDeviceStatus } from "./types";
