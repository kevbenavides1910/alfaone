...
function resolveSubtotalForContract(
  contract: {
    ...
    billingHistory: { periodMonth: Date; monthlyBilling: Decimal | number | string }[];
    ...
    if (existing) {
      ...
      await db.facturaMensual.update({
        ...
        data: {
          ...
          billingPeriodFromDayCopied: payload.billingPeriodFromDay,
          billingPeriodToDayCopied: payload.billingPeriodToDay,
