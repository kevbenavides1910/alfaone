...
const PATH_LABELS: Array<{ prefix: string; label: string; toolHint?: string }> = [
  ...
  { prefix: "/expenses/pendientes-asignar", label: "Gastos / Pendientes de asignar", toolHint: "list_pending_assign_payments" },
  { prefix: "/expenses", label: "Gastos", toolHint: "list_expenses, query_expenses_totals, search_ordenes_compra_codisa, list_pending_assign_payments" },
  ...
  { prefix: "/finger-system/dispositivos", label: "Finger System / Dispositivos", toolHint: "list_finger_devices" },
  { prefix: "/finger-system", label: "Finger System", toolHint: "query_finger_dashboard, list_finger_punches, list_finger_devices" },
  ...
  { prefix: "/sig/auditorias/capa", label: "SIG / CAPA", toolHint: "query_sig_capa, query_sig_audit_quarter" },
  { prefix: "/sig/vigencias", label: "SIG / Vigencias", toolHint: "list_sig_vigencias, list_sig_documents" },
  { prefix: "/sig/bandeja", label: "SIG / Bandeja", toolHint: "list_sig_vigencias, query_sig_capa, list_sig_documents" },
